...
<head>
    ...
    <title><?= esc($page_title ?? 'Manajemen Pelanggan Admin Djaya Aspalt') ?></title>
...
<body>
    <div class="admin-wrapper">
        <div class="admin-sidebar">
            <div class="sidebar-header">
                ...
                <h5>ADMIN DJAYA ASPALT</h5>
            </div>
            <div class="sidebar-menu">
                <a href="<?= base_url('admin') ?>" class="<?= (uri_string() == 'admin') ? 'active' : '' ?>">Home</a>

                <a href="<?= base_url('admin/pelanggan') ?>" class="<?= (strpos(uri_string(), 'admin/pelanggan') !== false && uri_string() != 'admin/pelanggan/tambah') ? 'active' : '' ?>">Daftar Pelanggan</a>
                <a href="<?= base_url('admin/pelanggan/tambah') ?>" class="<?= (uri_string() == 'admin/pelanggan/tambah') ? 'active' : '' ?>">Tambah Pelanggan</a>
                <a href="<?= base_url('admin/pelaksanaan') ?>" class="<?= (strpos(uri_string(), 'admin/pelaksanaan') !== false) ? 'active' : '' ?>">Pelaksanaan</a>
                ...
                <a href="<?= base_url('admin/alat') ?>" class="<?= (strpos(uri_string(), 'admin/alat') !== false) ? 'active' : '' ?>">Alat</a>
    ...
    <script>
        // PASTE SEMUA KODE JAVASCRIPT DARI LANGKAH 1 DI SINI (jika ada yang spesifik untuk layout ini)
    </script>
</body>
</html>