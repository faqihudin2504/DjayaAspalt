                    ...
                    <?php foreach ($items as $item): ?>
                        <tr>
                            ...
                            <td class="action-buttons">
                                <a href="<?= base_url('admin/pemesanan/view/' . $item['id_pesanan']) ?>" class="btn btn-info btn-sm">Detail</a>
                                <a href="<?= base_url('admin/pemesanan/edit/' . $item['id_pesanan']) ?>" class="btn btn-warning btn-sm">Ubah</a>
                                <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#confirmDeleteModal" data-url="<?= base_url('admin/pemesanan/hapus/' . $item['id_pesanan']) ?>">
                                    Hapus
                                </button>
                            </td>
                        </tr>
