...
<div class="card card-revisi">
    <div class="card-header">
        ...
        <div><a href="#" class="btn btn-light btn-sm">Cari</a><a href="#" class="btn btn-dark btn-sm">View</a><a href="#" class="btn btn-warning btn-sm">Edit</a><a href="#" class="btn btn-danger btn-sm">Hapus</a></div>
    </div>
    <div class="card-body table-responsive p-0">
        <table class="table table-bordered table-striped mb-0">
            <thead><tr><th>ID Alat</th><th>Cek Alat</th><th>Nama Alat</th><th>Stok</th><th>Informasi</th><th>Aksi</th></tr></thead>
            <tbody>
                <tr><td colspan="6"><div class="empty-state"><img src="<?= base_url('assets/table_cat_animated.gif') ?>"><h5 class="text-danger">Tidak Ada Data Alat</h5></div></td></tr>
            </tbody>
        </table>
    </div>
</div>
