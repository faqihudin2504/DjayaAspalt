...
<div class="row">
    <?php if (empty($alat_list)): ?>
        <div class="col-12 text-center p-5">
            <h5 class="text-danger">Belum ada data Alat Berat.</h5>
        </div>
    <?php else: ?>
        <?php foreach($alat_list as $alat): ?>
            <div class="col-lg-3 col-md-4 col-6 mb-4">
                <div class="admin-card h-100">
                    <img src="<?= base_url('uploads/alat/' . ($alat['gambar_alat'] ?: 'default.png')) ?>" class="img-fluid rounded mb-3" style="height: 150px; object-fit: cover;" alt="<?= esc($alat['nama_alat']) ?>">
