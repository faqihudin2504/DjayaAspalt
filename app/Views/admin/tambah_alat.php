...
<h4 class="mb-4 fw-bold">Tambah Data Alat</h4>
        ...
        <form action="<?= base_url('admin/alat/simpan') ?>" method="post">
            ...
            <div class="mb-3">
             ...
             <div class="mb-3">
                ...
                <input type="text" class="form-control" id="cek_alat" name="cek_alat" value="Tersedia" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="stok_alat" name="stok_alat" min="0" required>
            </div>
            <div class="mb-3">
                <label for="informasi_alat" class="form-label">Informasi Alat</label>
                <textarea class="form-control" id="informasi_alat" name="informasi_alat" rows="4" required></textarea>
            </div>
            <div class="mt-4">
